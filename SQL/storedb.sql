...
--
-- Host: localhost:3306
-- Generation Time: May 26, 2020 at 09:17 AM
...
(1, 'أحمد ', '032324222', 'dsdaewqe3232@yahoo.com', 'cairo');
...
(8, 'راشد', '$2a$10$RKe0Husb9UMDoZMNgFDJR.CPv/ecj/yWTOSfUWagauIFIDY46gXLS', 'm@y.com', '12345', '2020-05-25', '2020-05-25 10:17:03', 4, 1),
(9, 'أحمد', '$2a$10$RKe0Husb9UMDoZMNgFDJR.CPv/ecj/yWTOSfUWagauIFIDY46gXLS', 'as@y.com', '12345', '2020-05-25', '2020-05-25 10:19:25', 4, 1);
...
(1, '/suppliers/create', 'إنشاء مورد جديد'),
(3, '/suppliers/edit', 'تعديل مورد'),
(4, '/suppliers/delete', 'حذف مورد'),
(5, '/suppliers', 'عرض الموردين'),
(6, '/clients', 'عرض العملاء'),
(7, '/clients/create', 'إضافة عميل'),
(8, '/clients/edit', 'تعديل عميل'),
(11, '/clients/delete', 'حذف العميل'),
(17, 'test', 'test');
...
--
ALTER TABLE `app_users_privileges`
  MODIFY `PrivilegeId` tinyint(3) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
