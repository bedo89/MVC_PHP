<nav class="main_navigation <?= (isset($_COOKIE['menu_opened']) && $_COOKIE['menu_opened'] == 'true') ? 'opened no_animation' : '' ?>">
    <div class="employee_info">
        ...
        <span class="name"><?= $_SESSION['lang'] == 'ar' ? 'عبد الرحمن عصام' : 'Abdelrahman Esam' ?></span>
        <span class="privilege"><?= $text_app_manager ?></span>
    </div>

    <ul class="app_navigation">
        <li class="<?= $this->matchUrl('/') ? 'selected' : ''; ?>"><a href="/"><i class="fa fa-dashboard"></i><?= $text_general_statistics ?></a></li>

        <li class="submenu <?= $this->matchUrl('/purchases') || $this->matchUrl('/sales') ? 'selected' : ''; ?>">
        ...
        <li class="submenu <?= $this->matchUrl('/users') || $this->matchUrl('/usersgroups') || $this->matchUrl('/privileges') ? 'selected' : ''; ?>">
        ...
        <li class="<?= $this->matchUrl('/reports') ? 'selected' : ''; ?>"><a href="/reports"><i class="fa fa-bar-chart"></i><?= $text_reports ?></a></li>
        <li class="<?= $this->matchUrl('/notifications') ? 'selected' : ''; ?>"><a href="/notifications"><i class="fa fa-bell"></i><?= $text_notifications ?></a></li>
...
//if(isset($_SESSION['msg'])) {
    //$msg = $_SESSION['msg'];
    //echo '<div class="alert"><span class="closebtn" onclick="this.parentElement.style.display=\'none\';">&times;</span>'.$msg.'</div>';
