...
class EmployeeController extends AbstractController
{
    ...
    public function defaultAction()
    {
        ...
        //var_dump($this->_language->load($this));
        //var_dump($_SESSION);
    ...
    public function addAction()
    {
        ...
        if(isset($_POST['submit'])){
            ...
            if($emp->save()){
                $_SESSION['message'] = 'تم حفظ بيانات الموظف ' . $emp->name . ' بنجاح';
    ...
    public function editAction()
    {
        ...
        if(isset($_POST['submit'])){
            ...
            $emp->notes = $this->filterString($_POST['notes']);
            if($emp->save()){
                $_SESSION['message'] = 'تم تعديل بيانات الموظف ' . $emp->name . ' بنجاح';
                $this->redirect('/employee');
    ...
    public function deleteAction()
    {
        ...
        if($emp->delete()) {
            $_SESSION['message'] = 'تم حذف بيانات الموظف ' . $emp->name . ' بنجاح';
            $this->redirect('/employee');
        }
