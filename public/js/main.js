...
{
    evt.preventDefault();
    console.log($(this).attr('data-menu-status'));
...
(function ()
{
    ...
    userNameField.addEventListener('blur', function () {
            ...
            req.open('POST', 'http://mvcapp.com/users/checkUserExistsAjax');
            ...
            req.onreadystatechange = function () {
                if (req.readyState == req.DONE && req.status == 200) {
                    ...
                    for (var i = 0, ii = iElems.length; i < ii; i++) {
                        if (iElems[i].nodeName.toLocaleLowerCase() == 'i') {
                            iElems[i].remove();
                        }
                    }
            ...
            if(this.value) {
                ...
                if(this.parentNode.lastElementChild.nodeName.toLowerCase() == 'i') {
